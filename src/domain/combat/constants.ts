...
export const NEBULA_CENTER = { x: 1_160, y: 1_075 } as const;
export const NEBULA_RADIUS = 260;
export const NEBULA_DAMAGE_REDUCTION = 0.25;

export const SHIELD_BOOST_COST = 16;
export const SHIELD_BOOST_RESTORE = 20;
export const SHIELD_BOOST_DURATION_MS = 3_500;
export const SHIELD_BOOST_COOLDOWN_MS = 12_000;
export const SHIELD_BOOST_DAMAGE_REDUCTION = 0.35;
