...
export const WEAPONS: Readonly<Record<WeaponKind, WeaponDefinition>> = {
  broadside: {
    kind: 'broadside', name: 'Mass Driver Broadside', arc: 'broadside', range: 760, halfAngle: degrees(48),
    energyCost: 3, damage: 24, shieldMultiplier: 1, cooldownMs: 4_200,
  },
  lance: {
    kind: 'lance', name: 'Rift Lance', arc: 'front', range: 1_450, halfAngle: degrees(38),
    energyCost: 18, damage: 38, shieldMultiplier: 1.3, cooldownMs: 7_500, chargeMs: 1_600,
  },
  torpedo: {
    kind: 'torpedo', name: 'Void Torpedo', arc: 'front', range: 1_700, halfAngle: degrees(48),
    energyCost: 12, damage: 46, shieldMultiplier: 1, cooldownMs: 9_500,
    projectileSpeed: 280, projectileTurnRate: degrees(78),
  },
};
...
export const SHIPS: readonly ShipDefinition[] = [
  {
    ...
    weapons: ['broadside', 'lance', 'torpedo'], startPosition: { x: 470, y: 610 }, startFacing: 0,
  },
  {
    ...
    weapons: ['lance', 'torpedo'], startPosition: { x: 360, y: 850 }, startFacing: 0,
  },
  {
    ...
    weapons: ['broadside', 'lance'], startPosition: { x: 1_820, y: 540 }, startFacing: Math.PI,
  },
  {
    ...
    weapons: ['lance', 'torpedo'], startPosition: { x: 1_930, y: 860 }, startFacing: Math.PI,
  },
];
